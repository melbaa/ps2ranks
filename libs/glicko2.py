...
MU = 1500
PHI = 350 #RD
SIGMA = 0.06 #??volatility sigma 0.06 in paper
TAU = 1.0  #??should be the system contstant r, constraining the change in volatility
EPSILON = 0.000001
...
class Glicko2(object):
    ...
    def quality_1vs1(self, rating1, rating2):
        rating1 = self.scale_down(rating1)
        rating2 = self.scale_down(rating2)
    ...
    def winpct_1vs1(self,rating1,rating2):
        rating1 = self.scale_down(rating1)
        rating2 = self.scale_down(rating2)
        expected_score1 = self.expect_score(rating1, rating2, self.reduce_impact(rating1))
        expected_score2 = self.expect_score(rating2, rating1, self.reduce_impact(rating2))
        return expected_score1*100, expected_score2*100